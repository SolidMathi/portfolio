...
const translations = {
  es: {
    ...
    about_text: "Soy Mathias Coronel, Desarrollador Full-Stack especializado en el ecosistema PHP con más de 5 años de experiencia. Mi expertise se centra en Laravel, donde diseño arquitecturas MVC robustas y escalables para aplicaciones web complejas, garantizando un código limpio, mantenible y una lógica de negocio eficiente.<br><br>Complemento mi desarrollo backend con Laravel Livewire para crear interfaces dinámicas, reactivas y de una sola página (SPA) sin la complejidad de un framework JavaScript externo, lo que me permite ser altamente productivo y mantener la coherencia en todo el stack. Esta combinación me permite abordar proyectos de principio a fin, desde la API y la base de datos hasta la experiencia de usuario final.<br><br>Mi filosofía se basa en la entrega de software bien estructurado, seguro y enfocado en el rendimiento. Fuera del código, canalizo mi creatividad y lógica desarrollando videojuegos como pasatiempo, una pasión que refuerza mi pensamiento sistémico y mi capacidad para resolver problemas de forma innovadora.",
  ...
  en: {
    ...
    about_text: "I'm Mathias Coronel, a Full-Stack Developer specialized in the PHP ecosystem with over 5 years of experience. My expertise focuses on Laravel, where I design robust and scalable MVC architectures for complex web applications, ensuring clean, maintainable code and efficient business logic.<br><br>I complement my backend development with Laravel Livewire to create dynamic, reactive single-page applications (SPA) without the complexity of an external JavaScript framework, allowing me to be highly productive and maintain consistency across the stack. This combination enables me to tackle projects from start to finish, from API and database to the final user experience.<br><br>My philosophy is based on delivering well-structured, secure, performance-focused software. Outside of coding, I channel my creativity and logic by developing video games as a hobby, a passion that reinforces my systemic thinking and ability to solve problems innovatively.",
